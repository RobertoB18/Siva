    ...
    <div>
      <div className="flex flex-col items-start ms-16 mt-6 w-3/4 h-auto">
        ...
        <div className="mt-2 flex gap-2">
          <Link href="./clientes/newCliente" className="flex items-center justify-center bg-black text-white h-10 w-auto text-lg font-bold rounded-lg hover:bg-slate-600">+ Nuevo Cliente</Link>
        </div>
      </div>
